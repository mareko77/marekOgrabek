        ...
        success: function(result) {
            ...
            if (result.status.name == "ok") {    
                ...
                employees.forEach(employee => {
                    $("#employeeTbody").append($(`<tr role="button" data-id="${employee.id}">
                                                    ...
                                                    <div class="container-details container justify-content-center" >
                                                        <div class="employee-details-card card p-2">
                                                            <div class="card-body d-flex justify-content-center" id="ed-name">
                                                                <h4 class="card-title p-2 "><strong>${employee.firstName}</strong></h4>
                                                                <h4 class="card-title p-2"><strong>${employee.lastName}</strong></h4>
                                                            </div>
                                                            <div class="d-flex justify-content-center mt-3">
                                                                <table class="ed-table table justify-content-between table-responsive">
                                                                    <tbody id="ed-tbody">
                                                                            ...
                                                                            <tr>
                                                                                <td><a href="mailto:${employee.email}">Email: </a></td>
